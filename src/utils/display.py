...
def print_trading_output(decisions: dict, analyst_signals: dict = None) -> None:
    """
    Print formatted trading results with colored tables for multiple tickers.

    Args:
        decisions (dict): Dictionary containing trading decisions for multiple tickers
        analyst_signals (dict): Dictionary containing analyst signals for multiple tickers
    """
    if not decisions:
